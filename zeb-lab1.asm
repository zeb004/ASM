...
; This program allows the user to input two base-2 integers, adds them, and displays their 16-bit sum.
...
section .data
prompt0	 db	"Hello, my name is:  Zachary Beardmore", CR, LF, CR, LF, EOS 
prompt1: db	"Please enter a binary number: ", EOS
prompt2: db	"Please enter a second binary number: ", EOS
prompt3: db	CR,LF, "The sum of the two numbers you entered is:    ", EOS
...
section .text	
start:  
	mov	ah,9		; print greeting prompt (Prepare to enter data)
	mov	dx,prompt0
	int 	21h
	...
	add	bx,[temp]	; add the saved number to bx
